...
def query_onet_news():
    ...
    url = 'https://www.komputerswiat.pl/archiwum/'
...
if __name__ == '__main__':
    ...
    file_name_zst = './komputerswiat_pl_news_corpus.jsonl.zst'
    file_name_manifest = './komputerswiat_pl_news_corpus.manifest'
    ...
    with Pool(initializer=initialize_worker, processes=os.cpu_count(), maxtasksperchild=1000) as pool:
        ...
        for ok, txt, meta in pool.imap(func=process_item, iterable=query_onet_news(), chunksize=1):
            total += 1
            if ok:
    ...
    manifest = {"project" : "SpeakLeash", "name": "komputerswiat_pl_news_corpus", "description": "Collection of news from komputerswiat.pl corpus", "license": "(c) www.komputerswiat.pl", "Category": "Internet", "language": "pl", "file_size" : file_size, "sources": [{"name": "komputerswiat_pl_news_corpus", "url": "https://wwww.komputerswiat.pl", "license": "(c) www.komputereswait.pl"}], "stats": {"documents": total_docs, "sentences": total_sentences, "words" : total_words, "nouns" : total_nouns, "verbs" : total_verbs, "characters": total_len, "punctuations" : total_punctuations, "symbols" : total_symbols, "stopwords": total_stopwords}}
