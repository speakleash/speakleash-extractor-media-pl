...
def query_onet_news():
    ...
    url = 'https://www.businessinsider.com.pl/archiwum/'
    ...
    while date <= datetime.date.today():
        ...
        if response.ok:
            ...
            results = soup.find_all("li", class_="archive-article--li")
            for res in results:    
                for a in res.find_all("a", class_="archive-day"):        
                        title = a.text
                        item_url = a["href"]
                        # urls with '/international/' are English texts
                        if not '/international/' in item_url:
...
def initialize_worker():
    ...
    rp.set_url('https://www.businessinsider.com.pl/robots.txt')
    rp.read()
...
if __name__ == '__main__':
    ...
    file_name_zst = './businessinsider_pl_news_corpus.jsonl.zst'
    file_name_manifest = './businessinsider_pl_news_corpus.manifest'
    ...
    manifest = {"project" : "SpeakLeash", "name": "businessinsider_pl_news_corpus", "description": "Collection of news from businessinsider.com.pl corpus", "license": "(c) www.businessinsider.com.pl", "Category": "Internet", "language": "pl", "file_size" : file_size, "sources": [{"name": "businessinsider_pl_news_corpus", "url": "https://www.businessinsider.com.pl", "license": "(c) www.businessinsider.com.pl"}], "stats": {"documents": total_docs, "sentences": total_sentences, "words" : total_words, "nouns" : total_nouns, "verbs" : total_verbs, "characters": total_len, "punctuations" : total_punctuations, "symbols" : total_symbols, "stopwords": total_stopwords}}
