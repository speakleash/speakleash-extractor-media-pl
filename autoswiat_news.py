...
def query_onet_news():
    ...
    url = 'https://www.auto-swiat.pl/archiwum/'
...
def initialize_worker():
    ...
    rp.set_url('https://www.auto-swiat.pl/robots.txt')
    rp.read()
...
if __name__ == '__main__':
    ...
    file_name_zst = './autoswiat_pl_news_corpus.jsonl.zst'
    file_name_manifest = './autoswiat_pl_news_corpus.manifest'
    ...
    manifest = {"project" : "SpeakLeash", "name": "autoswiat_pl_news_corpus", "description": "Collection of news from auto-swiat.pl corpus", "license": "(c) www.auto-swiat.pl", "Category": "Internet", "language": "pl", "file_size" : file_size, "sources": [{"name": "komputerswiat_pl_news_corpus", "url": "https://wwww.auto-swiat.pl", "license": "(c) www.auto-swiat.pl"}], "stats": {"documents": total_docs, "sentences": total_sentences, "words" : total_words, "nouns" : total_nouns, "verbs" : total_verbs, "characters": total_len, "punctuations" : total_punctuations, "symbols" : total_symbols, "stopwords": total_stopwords}}
